 ...
 */
class ClientPermission extends \com\novaconcept\entity\ClientPermission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'com\\novaconcept\\entity\\ClientPermission' . "\0" . 'id', '' . "\0" . 'com\\novaconcept\\entity\\ClientPermission' . "\0" . 'name', '' . "\0" . 'com\\novaconcept\\entity\\ClientPermission' . "\0" . 'description', '' . "\0" . 'com\\novaconcept\\entity\\ClientPermission' . "\0" . 'isActive', '' . "\0" . 'com\\novaconcept\\entity\\ClientPermission' . "\0" . 'createdOn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClientPermission $proxy) {
