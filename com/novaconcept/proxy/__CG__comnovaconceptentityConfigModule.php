 ...
 */
class ConfigModule extends \com\novaconcept\entity\ConfigModule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'com\\novaconcept\\entity\\ConfigModule' . "\0" . 'clientInfo', '' . "\0" . 'com\\novaconcept\\entity\\ConfigModule' . "\0" . 'isActive', '' . "\0" . 'com\\novaconcept\\entity\\ConfigModule' . "\0" . 'endpoint', '' . "\0" . 'com\\novaconcept\\entity\\ConfigModule' . "\0" . 'configEventCollection', '' . "\0" . 'com\\novaconcept\\entity\\ConfigModule' . "\0" . 'configListenerCollection');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConfigModule $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getConfigEventCollection()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConfigEventCollection', array());

        return parent::getConfigEventCollection();
    }
