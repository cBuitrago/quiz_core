 ...
 */
class ConfigEvent extends \com\novaconcept\entity\ConfigEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'com\\novaconcept\\entity\\ConfigEvent' . "\0" . 'id', '' . "\0" . 'com\\novaconcept\\entity\\ConfigEvent' . "\0" . 'isActive', '' . "\0" . 'com\\novaconcept\\entity\\ConfigEvent' . "\0" . 'configModule', '' . "\0" . 'com\\novaconcept\\entity\\ConfigEvent' . "\0" . 'tag', '' . "\0" . 'com\\novaconcept\\entity\\ConfigEvent' . "\0" . 'configListenerCollection');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConfigEvent $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getConfigListenerCollection()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConfigListenerCollection', array());

        return parent::getConfigListenerCollection();
    }
