 ...
 */
class AccountCompany extends \com\novaconcept\entity\AccountCompany implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'com\\novaconcept\\entity\\AccountCompany' . "\0" . 'id', '' . "\0" . 'com\\novaconcept\\entity\\AccountCompany' . "\0" . 'name', '' . "\0" . 'com\\novaconcept\\entity\\AccountCompany' . "\0" . 'accountInfoCollection');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccountCompany $proxy) {
