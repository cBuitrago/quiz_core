 ...
 */
class UserPermission extends \com\novaconcept\entity\UserPermission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'com\\novaconcept\\entity\\UserPermission' . "\0" . 'id', '' . "\0" . 'com\\novaconcept\\entity\\UserPermission' . "\0" . 'name', '' . "\0" . 'com\\novaconcept\\entity\\UserPermission' . "\0" . 'description', '' . "\0" . 'com\\novaconcept\\entity\\UserPermission' . "\0" . 'isActive', '' . "\0" . 'com\\novaconcept\\entity\\UserPermission' . "\0" . 'createdOn', '' . "\0" . 'com\\novaconcept\\entity\\UserPermission' . "\0" . 'userAuthorizationCollection');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserPermission $proxy) {
